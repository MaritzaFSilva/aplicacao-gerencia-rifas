...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { description: @award.description, placing: @award.placing, rifa_id_id: @award.rifa_id_id, ticket_drawn_id: @award.ticket_drawn_id } }
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { description: @award.description, placing: @award.placing, rifa_id_id: @award.rifa_id_id, ticket_drawn_id: @award.ticket_drawn_id } }
