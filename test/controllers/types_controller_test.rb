...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { description: @type.description, initial_number: @type.initial_number, number_of_tickets: @type.number_of_tickets, step: @type.step } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { description: @type.description, initial_number: @type.initial_number, number_of_tickets: @type.number_of_tickets, step: @type.step } }
